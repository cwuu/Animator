...
{ 
	...
	INVERSE_KINEMATICS, CONSTRAINT_X, CONSTRAINT_Y, CONSTRAINT_Z, METABALL, PARTICLE_NUM,
	SKYBOX,HEIGHT_FIELD,ACCUMULATION_BUFFER,
	ENABLE_IK, IK_LEG_X, IK_LEG_Y, IK_LEG_Z,
	NUMCONTROLS
};
